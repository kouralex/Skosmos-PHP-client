<?php
/**
 * Invalid option value exception class.
 *
 * PHP version 7.3
 *
 ...
 * Invalid option value exception class.
 *
 * Represents an invalid value given to a console option.
 */
class InvalidOptionValueException extends InvalidOptionException
{
}

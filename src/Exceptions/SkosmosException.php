<?php
/**
 * Abstract Skosmos exception base class.
 *
 * PHP version 7.3
 *
 ...
 */
namespace NatLibFi\SkosmosClient\Exceptions;
 ...
 * Abstract Skosmos exception base class.
 *
 * SkosmosException is the abstract base class for all Skosmos REST API related exceptions.
 */
abstract class SkosmosException extends \Exception implements SkosmosExceptionInterface
{
}

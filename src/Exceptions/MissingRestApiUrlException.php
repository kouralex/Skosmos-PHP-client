<?php
/**
 * Skosmos missing REST API URL exception class.
 *
 * PHP version 7.3
 *
 ...
 * Skosmos missing REST API URL exception class.
 *
 * Represents missing service endpoint (Skosmos REST API base URL).
 */
class MissingRestApiUrlException extends \RuntimeException
{
}

<?php
/**
 * Vocabulary-specific labelStatistics method console command.
 *
 * PHP version 7.3
 *
 ...
 * Vocabulary-specific labelStatistics method console command.
 */
class VocabularyLabelStatisticsCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/labelStatistics';

    protected static $defaultDescription = 'Number of labels by language';

    protected const CLIENT_METHOD_NAME = 'vocabularyLabelStatistics';
    ...
    {
        $this->setHelp('This command allows you to get the label (skos:prefLabel, skos:altLabel and skos:hiddenLabel) counts in all the different languages.');

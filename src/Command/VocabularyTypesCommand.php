<?php
/**
 * Vocabulary-specific types method console command.
 *
 * PHP version 7.3
 *
 ...
 * Vocabulary-specific types method console command.
 */
class VocabularyTypesCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/types';

    protected static $defaultDescription = 'Information about the types (classes) of objects in the vocabulary';

    protected const CLIENT_METHOD_NAME = 'vocabularyTypes';

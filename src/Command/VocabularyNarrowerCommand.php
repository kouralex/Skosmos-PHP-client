<?php
/**
 * Concept-specific narrower method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific narrower method console command.
 */
class VocabularyNarrowerCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/narrower';

    protected static $defaultDescription = 'Narrower concepts of the requested concept';

    protected const CLIENT_METHOD_NAME = 'vocabularyNarrower';
    ...
    {
        $this->setHelp('This command allows you to get the narrower concepts of the requested concept.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose narrower concept to return'),
        ];

<?php
/**
 * Concept-specific children method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific children method console command.
 */
class VocabularyChildrenCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/children';

    protected static $defaultDescription = 'Narrower concepts of the requested concept (to be used in a hierarchical display)';

    protected const CLIENT_METHOD_NAME = 'vocabularyChildren';
    ...
    {
        $this->setHelp('This command allows you to get the children (narrower concepts) of the requested concept. The data is intended to be used in a hierarchical display.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose narrower concepts to return'),
        ];

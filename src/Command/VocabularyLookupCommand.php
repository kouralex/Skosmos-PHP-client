<?php
/**
 * Vocabulary-specific lookup method console command.
 *
 * PHP version 7.3
 *
 ...
 * Vocabulary-specific lookup method console command.
 */
class VocabularyLookupCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/lookup';

    protected static $defaultDescription = 'Look up concepts by label';

    protected const CLIENT_METHOD_NAME = 'vocabularyLookup';
    ...
    {
        $this->setHelp('This command allows you to get information about the types (classes) of objects in the vocabulary.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_LABEL, InputArgument::REQUIRED, 'The label to look for, e.g. "cat" or "dog"'),
        ];

        // Generate method/command related options array.
        $this->commandOpts = [
            new InputOption(self::ARG_LANG, null, InputOption::VALUE_REQUIRED, 'Search language, e.g. "en" or "fi"'),
        ];

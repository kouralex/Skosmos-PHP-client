<?php
/**
 * Concept-specific label method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific label method console command.
 */
class VocabularyLabelCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/label';

    protected static $defaultDescription = 'List of labels for the requested concept';

    protected const CLIENT_METHOD_NAME = 'vocabularyLabel';
    ...
    {
        $this->setHelp('This command allows you to get labels for the requested concept.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose labels to return'),
        ];

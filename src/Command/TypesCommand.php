<?php
/**
 * Global types method console command.
 *
 * PHP version 7.3
 *
 ...
 * Global types method console command.
 */
class TypesCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:types';

    protected static $defaultDescription = 'Information about the types (classes) of objects contained in all vocabularies';

    protected const CLIENT_METHOD_NAME = 'types';
    ...
    {
        $this->setHelp('This command allows you to get information about the types (classes) of objects contained in all vocabularies.');

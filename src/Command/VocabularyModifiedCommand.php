<?php
/**
 * Vocabulary-specific modified method console command.
 *
 * PHP version 7.3
 *
 ...
 * Vocabulary-specific modified method console command.
 */
class VocabularyModifiedCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/modified';

    protected static $defaultDescription = 'Modified concepts in the vocabulary';

    protected const CLIENT_METHOD_NAME = 'vocabularyModified';
    ...
    {
        $this->setHelp('This command allows you to list the most recently modified concepts of the vocabulary');

<?php
/**
 * Concept-specific broaderTransitive method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific broaderTransitive method console command.
 */
class VocabularyBroaderTransitiveCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/broaderTransitive';

    protected static $defaultDescription = 'Broader transitive hierarchy for the requested concept';

    protected const CLIENT_METHOD_NAME = 'vocabularyBroaderTransitive';
    ...
    {
        $this->setHelp('This command allows you to get the broader transitive hierarchy for the requested concept.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose broader transitive hierarchy to return'),
        ];

<?php
/**
 * Global label method console command.
 *
 * PHP version 7.3
 *
 ...
 * Global label method console command.
 */
class LabelCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:label';

    protected static $defaultDescription = 'List of labels for the requested concept';

    protected const CLIENT_METHOD_NAME = 'label';
    ...
    {
        $this->setHelp('This command allows you to list labels for the requested concept.');

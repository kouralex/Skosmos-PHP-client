<?php
/**
 * Concept-specific related method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific related method console command.
 */
class VocabularyRelatedCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/related';

    protected static $defaultDescription = 'Related concepts of the requested concept';

    protected const CLIENT_METHOD_NAME = 'vocabularyRelated';
    ...
    {
        $this->setHelp('This command allows you to get the related concepts of the requested concept.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose related concept to return'),
        ];

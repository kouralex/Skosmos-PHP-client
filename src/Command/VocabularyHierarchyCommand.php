<?php
/**
 * Concept-specific hierarchy method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific hierarchy method console command.
 */
class VocabularyHierarchyCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/hierarchy';

    protected static $defaultDescription = 'Hierarchical context of the requested concept';

    protected const CLIENT_METHOD_NAME = 'vocabularyHierarchy';
    ...
    {
        $this->setHelp('This command allows you to get the hierarchical context of the requested concept. The hierarchy is intended to be used in a hierarchical display.');

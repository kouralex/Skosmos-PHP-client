<?php
/**
 * Vocabulary-specific groups method console command.
 *
 * PHP version 7.3
 *
 ...
 * Vocabulary-specific groups method console command.
 */
class VocabularyGroupsCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/groups';

    protected static $defaultDescription = 'Concept groups in the vocabulary';

    protected const CLIENT_METHOD_NAME = 'vocabularyGroups';
    ...
    {
        $this->setHelp('This command allows you to get concept groups in the vocabulary.');

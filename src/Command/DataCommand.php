<?php
/**
 * Global data method console command.
 *
 * PHP version 7.3
 *
 ...
 * Global data method console command.
 */
class DataCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:data';

    protected static $defaultDescription = 'RDF data of the requested concept';

    protected const CLIENT_METHOD_NAME = 'data';
    ...
    {
        $this->setHelp('This command allows you to get the RDF data of the requested concept.');

        // Generate method/command related arguments array.
        $this->commandArgs = [
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose data to return'),
        ];

<?php
/**
 * Concept-specific broader method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific broader method console command.
 */
class VocabularyBroaderCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/broader';

    protected static $defaultDescription = 'Broader concepts of the requested concept';

    protected const CLIENT_METHOD_NAME = 'vocabularyBroader';
    ...
    {
        $this->setHelp('This command allows you to get the broader concepts of the requested concept.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose broader concept to return'),
        ];

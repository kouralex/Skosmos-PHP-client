<?php
/**
 * Concept-specific groupMembers method console command.
 *
 * PHP version 7.3
 *
 ...
 * Concept-specific groupMembers method console command.
 */
class VocabularyGroupMembersCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/groupMembers';

    protected static $defaultDescription = 'Members of the requested concept group';

    protected const CLIENT_METHOD_NAME = 'vocabularyGroupMembers';
    ...
    {
        $this->setHelp('This command allows you to get the member concepts of the requested concept group.');
        ...
        $this->commandArgs = [
            ...
            new InputArgument(self::ARG_URI, InputArgument::REQUIRED, 'URI of the concept whose member concepts to return'),
        ];

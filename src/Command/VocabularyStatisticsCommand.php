<?php
/**
 * Vocabulary-specific vocabularyStatistics method console command.
 *
 * PHP version 7.3
 *
 ...
 * Vocabulary-specific vocabularyStatistics method console command.
 */
class VocabularyStatisticsCommand extends AbstractSkosmosCommand
{
    protected static $defaultName = 'skosmos:vocid/vocabularyStatistics';

    protected static $defaultDescription = 'Number of Concepts and Collections in the vocabulary';

    protected const CLIENT_METHOD_NAME = 'vocabularyStatistics';
    ...
    {
        $this->setHelp('This command allows you to get the concept and group counts for the vocabulary.');
